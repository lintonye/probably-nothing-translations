...
export async function getPost(slug: string, parseMarkdown = true) {
  ...
  let content = parseMarkdown ? await processMarkdown(body) : body;
  return { slug, content, title: attributes.title };
}
